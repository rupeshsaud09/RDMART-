...
const CACHE = 'martai-v70';
const SHELL = [
  'index.html',
  'customer.html',
  'dashboard.html',
  'staff.html',
  'assets/martai.css?v=34',
  'assets/staff.css?v=10',
  'assets/login-experience.css?v=12',
  'assets/martai-date.js?v=1',
  'assets/martai-bank-cheques.js?v=3',
  'assets/martai-ui.js?v=2',
  'assets/martai-store.js?v=37',
  'assets/martai-notifications.js?v=1',
  ...
  'assets/khata-backup.js?v=6',
  'assets/martai-bot.js?v=12',
  'assets/martai-qr.js',
