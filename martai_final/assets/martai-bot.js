...
/* ---------- css ---------- */
const CSS=`
.mbot-fab{position:fixed;right:18px;bottom:18px;z-index:1200;width:66px;height:66px;border-radius:50%;border:none;cursor:pointer;background:#3B82F6;box-shadow:0 12px 30px rgba(59,130,246,.28);padding:6px;animation:mbotBob 3.4s ease-in-out infinite;transition:transform .2s}
...
.mbot-head{display:flex;align-items:center;gap:10px;padding:12px 14px;background:#102A43;border-bottom:1px solid rgba(255,255,255,.12);flex:none}
.mbot-hava{width:46px;height:46px;flex:none;border-radius:50%;background:#3B82F6;padding:3px;box-shadow:0 8px 20px rgba(0,0,0,.2)}
...
.mbot-hsub{font-size:10.5px;color:#BFDBFE;font-weight:800;display:flex;align-items:center;gap:5px;margin-top:2px}
.mbot-dot{width:7px;height:7px;border-radius:50%;background:#22C55E;box-shadow:0 0 0 3px rgba(34,197,94,.18);flex:none}
...
.mbot-mava{width:28px;height:28px;flex:none;border-radius:50%;background:#3B82F6;padding:2px}
...
.mbot-row.me .mbot-msg{background:#3B82F6;color:#fff;border-bottom-right-radius:5px;font-weight:700}
.mbot-acts{display:flex;gap:6px;flex-wrap:wrap;margin-top:9px}
.mbot-act{border:1px solid rgba(96,165,250,.5);background:rgba(59,130,246,.14);color:#BFDBFE;font-size:12px;font-weight:900;border-radius:999px;padding:6px 12px;cursor:pointer;transition:.15s;font-family:inherit}
.mbot-act:hover{background:#2563EB;color:#fff}
...
.mbot-typing span{width:7px;height:7px;border-radius:50%;background:#60A5FA;animation:mbotTyp 1s infinite}
...
.mbot-chip:hover{background:#3B82F6;color:#fff;border-color:transparent}
...
.mbot-in:focus{border-color:#3B82F6;box-shadow:0 0 0 3px rgba(59,130,246,.15)}
...
.mbot-send{background:#3B82F6;color:#fff}
...
body[data-theme="light"] .mbot-head{background:#EFF6FF;border-bottom-color:#E2E8F0}
body[data-theme="light"] .mbot-hname{color:#101413}
body[data-theme="light"] .mbot-hsub{color:#1D4ED8}
...
body[data-theme="light"] .mbot-act{background:#EFF6FF;border-color:#BFDBFE;color:#1D4ED8}
body[data-theme="light"] .mbot-act:hover{background:#DBEAFE;color:#1D4ED8}
/* Compact professional assistant: flat surfaces, no mascot or decorative motion. */
.mbot-fab{right:18px;bottom:18px;width:46px;height:46px;padding:0;border:1px solid #3B82F6;border-radius:14px;background:#3B82F6;box-shadow:0 5px 16px rgba(59,130,246,.22);animation:none;color:#fff;display:flex;align-items:center;justify-content:center;gap:0;font:700 11.5px Inter,ui-sans-serif,system-ui,sans-serif}
.mbot-fab:hover{transform:none;background:#2563EB}
.mbot-fab svg{width:17px;height:17px}
.mbot-fab-label{display:none}
.mbot-panel{bottom:72px;width:min(390px,calc(100vw - 24px));height:min(570px,calc(100vh - 100px));border-radius:12px;border-color:#243B53;background:#102A43;box-shadow:0 18px 48px rgba(15,23,42,.3);backdrop-filter:none}
.mbot-panel.open{animation:mbotIn .18s ease-out both}
.mbot-head{padding:11px 12px;background:#243B53;border-bottom-color:#35536F}
.mbot-hava,.mbot-mava{display:grid;place-items:center;border-radius:8px;background:#3B82F6;box-shadow:none;padding:7px}
...
.mbot-row.bot .mbot-msg{background:#243B53;border-color:#35536F;border-bottom-left-radius:9px}
.mbot-row.me .mbot-msg{background:#3B82F6;border-bottom-right-radius:9px;font-weight:600}
.mbot-chip,.mbot-act{border-radius:7px;font-weight:650}
.mbot-chip:hover{background:#3B82F6}
.mbot-inrow{background:#0B1F33}.mbot-in{border-radius:8px}.mbot-mic,.mbot-send{border-radius:8px}.mbot-send{background:#3B82F6}
