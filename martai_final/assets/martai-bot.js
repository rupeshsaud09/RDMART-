...
/* ---------- css ---------- */
const CSS=`
.mbot-fab{position:fixed;right:18px;bottom:18px;z-index:1200;width:66px;height:66px;border-radius:50%;border:none;cursor:pointer;background:linear-gradient(135deg,#8D2FF6,#5A214B);box-shadow:0 16px 42px rgba(141,47,246,.4);padding:6px;animation:mbotBob 3.4s ease-in-out infinite;transition:transform .2s}
...
.mbot-head{display:flex;align-items:center;gap:10px;padding:12px 14px;background:linear-gradient(135deg,rgba(141,47,246,.46),rgba(90,33,75,.24));border-bottom:1px solid rgba(255,255,255,.12);flex:none}
.mbot-hava{width:46px;height:46px;flex:none;border-radius:50%;background:linear-gradient(135deg,#8D2FF6,#5A214B);padding:3px;box-shadow:0 8px 20px rgba(0,0,0,.25)}
...
.mbot-hsub{font-size:10.5px;color:#F7EAF2;font-weight:800;display:flex;align-items:center;gap:5px;margin-top:2px}
.mbot-dot{width:7px;height:7px;border-radius:50%;background:#5A214B;box-shadow:0 0 0 3px rgba(90,33,75,.28);flex:none}
...
.mbot-mava{width:28px;height:28px;flex:none;border-radius:50%;background:linear-gradient(135deg,#8D2FF6,#5A214B);padding:2px}
...
.mbot-row.me .mbot-msg{background:linear-gradient(135deg,#8D2FF6,#5A214B);color:#fff;border-bottom-right-radius:5px;font-weight:700}
.mbot-acts{display:flex;gap:6px;flex-wrap:wrap;margin-top:9px}
.mbot-act{border:1px solid rgba(247,234,242,.5);background:rgba(90,33,75,.24);color:#F7EAF2;font-size:12px;font-weight:900;border-radius:999px;padding:6px 12px;cursor:pointer;transition:.15s;font-family:inherit}
.mbot-act:hover{background:rgba(90,33,75,.5);color:#fff}
...
.mbot-typing span{width:7px;height:7px;border-radius:50%;background:#D9A8C7;animation:mbotTyp 1s infinite}
...
.mbot-chip:hover{background:linear-gradient(135deg,#8D2FF6,#5A214B);color:#fff;border-color:transparent}
...
.mbot-in:focus{border-color:rgba(90,33,75,.78);box-shadow:0 0 0 3px rgba(90,33,75,.2)}
...
.mbot-send{background:linear-gradient(135deg,#8D2FF6,#5A214B);color:#fff}
...
body[data-theme="light"] .mbot-head{background:linear-gradient(135deg,rgba(141,47,246,.12),rgba(90,33,75,.12));border-bottom-color:rgba(141,47,246,.12)}
body[data-theme="light"] .mbot-hname{color:#101413}
body[data-theme="light"] .mbot-hsub{color:#6719B8}
...
body[data-theme="light"] .mbot-act{background:rgba(90,33,75,.08);border-color:rgba(90,33,75,.35);color:#5A214B}
body[data-theme="light"] .mbot-act:hover{background:rgba(90,33,75,.16);color:#431737}
/* Compact professional assistant: flat surfaces, no mascot or decorative motion. */
.mbot-fab{right:18px;bottom:18px;width:46px;height:46px;padding:0;border:1px solid #8D2FF6;border-radius:14px;background:linear-gradient(135deg,#8D2FF6,#5A214B);box-shadow:0 5px 16px rgba(141,47,246,.28);animation:none;color:#fff;display:flex;align-items:center;justify-content:center;gap:0;font:700 11.5px Inter,ui-sans-serif,system-ui,sans-serif}
.mbot-fab:hover{transform:none;background:#8D2FF6}
.mbot-fab svg{width:17px;height:17px}
.mbot-fab-label{display:none}
.mbot-panel{bottom:72px;width:min(390px,calc(100vw - 24px));height:min(570px,calc(100vh - 100px));border-radius:12px;border-color:#4B3060;background:#241533;box-shadow:0 18px 48px rgba(0,0,0,.32);backdrop-filter:none}
.mbot-panel.open{animation:mbotIn .18s ease-out both}
.mbot-head{padding:11px 12px;background:#301D43;border-bottom-color:#4B3060}
.mbot-hava,.mbot-mava{display:grid;place-items:center;border-radius:8px;background:linear-gradient(135deg,#8D2FF6,#5A214B);box-shadow:none;padding:7px}
.mbot-hava{width:38px;height:38px}.mbot-mava{width:26px;height:26px;padding:5px}
.mbot-hname{font-size:13.5px;font-weight:750}.mbot-hsub{color:#F7EAF2;font-size:9.5px;font-weight:650}
.mbot-dot{box-shadow:none}
.mbot-hbtn,.mbot-lang{border-radius:7px}
.mbot-msg{border-radius:9px;font-size:12.5px;line-height:1.6}
.mbot-row.bot .mbot-msg{background:#301D43;border-color:#4B3060;border-bottom-left-radius:9px}
.mbot-row.me .mbot-msg{background:linear-gradient(135deg,#8D2FF6,#5A214B);border-bottom-right-radius:9px;font-weight:600}
.mbot-chip,.mbot-act{border-radius:7px;font-weight:650}
.mbot-chip:hover{background:#5A214B}
.mbot-inrow{background:#180D25}.mbot-in{border-radius:8px}.mbot-mic,.mbot-send{border-radius:8px}.mbot-send{background:#5A214B}
...
body[data-theme="light"] .mbot-head{background:#F2E8FF;border-bottom-color:#E9DDE6}
